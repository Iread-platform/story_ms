...
docker run -p 217.182.250.236:${CONTAINER_PORT}:${INTERNAL_PORT} --restart on-failure --name ${DOCKER_CONTAINER_NAME} --hostname ${DOCKER_CONTAINER_NAME} -d ${DOCKER_IMAGE_AND_TAG};
